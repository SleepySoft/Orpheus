...
const BLOCK_RULES = [
  ...
  { re: /sleepingbeauty/i, name: 'SleepingBeauty', status: 'builtin', detail: 'sleeping_beauty（响度补偿）' },
  { re: /pooliir/i, name: 'pooliir IIR 加速器', status: 'builtin', detail: 'iir_bank（N 级 IIR，pooliir 近似）' },
  { re: /biquad/i, name: 'Biquad', status: 'builtin', detail: 'biquad / biquad_bank' },
  { re: /fir/i, name: 'FIR', status: 'builtin', detail: 'fir（kind: bulk 系数）' },
  { re: /ifft/i, name: 'IFFT', status: 'builtin', detail: 'ifft（半复数逆变换）' },
  { re: /(?:r?fft|stft)/i, name: 'FFT/RFFT', status: 'builtin', detail: 'rfft（半复数实数 FFT）' },
  ...
  { re: /inputmixer3d|downmix/i, name: 'InputMixer3D/Downmix', status: 'builtin', detail: 'input_mixer_3d（加权矩阵混音）' },
