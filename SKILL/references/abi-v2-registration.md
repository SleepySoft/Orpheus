...
> 2026-08-06 首次落地，设计全文见 `docs/HOW/reference/registry.md`。标题中的“ABI v2”指 state arena + `register_slots` 机制；当前整体 ABI 已为 v3。`gain`、`probe_rms`、`probe_waveform` 是最初试点，现有新组件应直接按本文机制实现。
