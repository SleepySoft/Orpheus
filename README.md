...
目前我就职于一家算是较为顶级的音频公司，学习到了音频处理的原理以及各种精妙的算法，也看到了商业应用中的各种音频模型。

公司有一套基于Simulink的可视化音频模型构建工具以及基于它之上的代码生成与调音系统。当然由于商业限制，这一套工具显然是非开放的。

世面上也有类似的软件，比如AWE，它同样基于Matlab。而且，很不幸地，它的License非常贵。

但我更忍受不了的是那简陋的界面，臃肿的代码和架构，以及完全封闭的生态。我想要一个现代的、免费的、开放的、直观的工具，并且这个工具要有可玩性，而非只能在DSP设备上上部署。
