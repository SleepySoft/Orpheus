...
_RULES: list[tuple[re.Pattern[str], str | None, str]] = [
    ...
    (re.compile(r"windowing|窗函数|窗", re.I), None, "missing"),
    (re.compile(r"limiter", re.I), None, "missing"),
    (re.compile(r"softclipper|clipper", re.I), None, "missing"),
    (re.compile(r"saturation", re.I), None, "missing"),
    (re.compile(r"matrixmultiply|矩阵乘", re.I), None, "missing"),
    (re.compile(r"coherence|相干", re.I), None, "missing"),
    (re.compile(r"noiseslew", re.I), None, "missing"),
    (re.compile(r"speedbounds", re.I), None, "missing"),
    (re.compile(r"leveldetect", re.I), None, "missing"),
    (re.compile(r"sleepingbeauty", re.I), None, "missing"),
    (re.compile(r"reverb", re.I), None, "missing"),
    (re.compile(r"switch", re.I), None, "missing"),
